...
//            e.printStackTrace();
    ...
    public ArrayList<WebElement> getElementsWithMcGyver(By locator) {
        try {
            ArrayList<WebElement> elements = (ArrayList) getDriver().findElements(locator);
            return elements;
        } catch (Exception e) {
...
//            e.printStackTrace();
    ...
    public void moveToElementWithoutClick(By locator){
        try {
            Actions actions = new Actions(getDriver());
            WebElement element = getDriver().findElement(locator);
            actions.moveToElement(element);
        }catch (Exception e){
            logFail("Não foi possivel mover o mouse até o elemento.");
        }
    }
...
//       e.printStackTrace();
        ...
        System.err.println("Erro. Elemento informado não está visível ou demorou muito ficar visível.");
        return false;
    }
    ...
    public boolean waitElementIsEnable(By locator, long timeout) throws InterruptedException {
        ...
        do {
            try {
                ...
                logFail("Não foi possivel aguardar o elemento ficar ativo.");
                //       e.printStackTrace();
            }
            Thread.sleep(250);
            count++;
...
//       //       e.printStackTrace();
     ...
     *
     */
    public void setSelect(By locator) {
        try {
            WebElement element = getDriver().findElement(locator);
            Select selectElement = new Select(getDriver().findElement(locator));
            if (element.isDisplayed() && element.isEnabled()) {
